...
import 'package:chomoka/view/dashboard/mgao_kikundi/mgao_mwanachama/cmg/mgao_mwanachama_summary.dart';
...
class MgaoWanachamaPage extends StatefulWidget {
  var mzungukoId;
  MgaoWanachamaPage({super.key, this.mzungukoId});

  @override
  _MgaoWanachamaPageState createState() => _MgaoWanachamaPageState();
}

class _MgaoWanachamaPageState extends State<MgaoWanachamaPage> {
  String _searchQuery = "";
                    ...
                    return GestureDetector(
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => MgaoMwanachamaSummary(
