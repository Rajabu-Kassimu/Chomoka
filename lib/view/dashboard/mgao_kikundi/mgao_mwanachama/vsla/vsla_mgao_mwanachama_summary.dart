...
class VslaMgaoMwanachamaSummary extends StatefulWidget {
  final Map<String, dynamic> user;
  var mzungukoId;
  final bool isFromVslaMgaoWanachama;

  VslaMgaoMwanachamaSummary({
    Key? key,
    required this.user,
    this.mzungukoId,
  ...
  @override
  State<VslaMgaoMwanachamaSummary> createState() => _VslaMgaoMwanachamaSummaryState();
}

class _VslaMgaoMwanachamaSummaryState extends State<VslaMgaoMwanachamaSummary> {
  ...
  Future<void> _fetchTotalSharesForUser() async {
    try {
      ...
      print('Total shares for user ${widget.user['id']}: $_totalSharesCount worth $_totalSharesValue');
    } catch (e) {
  ...
  getTotalMgao() {
    double total = _totalSharesValue - _unpaidLoanAmount - _unpaidFainiAmount;
    setState(() {
      jumlaFedha = total;
    });
  }
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 12),
                    buildSummaryRow(l10n.totalSharesCount, _totalSharesCount.toString()),
                    Divider(),
                    buildSummaryRow(l10n.shareValue, _shareValue.toStringAsFixed(0)),
                    Divider(),
                    buildSummaryRow(l10n.totalSharesValue, _totalSharesValue.toStringAsFixed(0)),
                    Divider(),
                    if (_hasUnpaidLoan)
                      buildSummaryRow(
                    ...
                    if (_hasUnpaidFaini || _hasUnpaidLoan) Divider(),
                    jumlaFedha < 0
                        ? buildSummaryRow(
                ...
                Navigator.push(
                  ...
                  MaterialPageRoute(
                      builder: (context) => LoginPage(
                          ...
                          withdrawAmount: _totalSharesValue.toStringAsFixed(0),
                          isFromVslaMgaoWanachama: true)),
                );
